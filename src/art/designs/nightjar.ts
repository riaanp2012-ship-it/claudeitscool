...
const fuselage = new Profile([
  ...
  { z: 0.6, s: sym(-0.05, 0.22, 0.12, 0.1, 1.7, 1.7) },
  { z: 1.6, s: sym(-0.03, 0.46, 0.26, 0.2, 1.7, 1.7) },
  { z: 2.8, s: sym(0.0, 0.66, 0.39, 0.3, 1.7, 1.7) },
  { z: 4.0, s: sym(0.04, 0.8, 0.5, 0.38, 1.7, 1.7) },
  { z: 5.5, s: sym(0.04, 0.98, 0.52, 0.45, 1.7, 1.7) },
  { z: 7.0, s: sym(0.02, 1.45, 0.54, 0.55, 1.8, 1.8) },
  { z: 9.0, s: sym(0.0, 1.6, 0.55, 0.55, 1.8, 1.8) },
  { z: 12.0, s: sym(0.0, 1.6, 0.5, 0.5, 1.8, 1.8) },
...
function build(ctx: BuildContext): void {
  ...
  pilot(ctx, eye, { z: 3.75, w: 0.28, y: 0.56 });
  ...
  bay(ctx, 'bottom', [-1.2, -0.5, 10.82], 0.2, 0.85);
  bay(ctx, 'top', [0, 0.58, 4.8], 0.36, 1.4);
}
