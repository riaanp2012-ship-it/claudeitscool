...
const fuselage = new Profile([
  ...
  { z: 7.4, s: sym(0.02, 0.6, 0.62, 0.55, 2.6, 2.9) },
  { z: 8.4, s: sym(0.0, 0.62, 0.62, 0.56, 2.7, 2.9) },
  { z: 9.6, s: sym(0.0, 0.6, 0.6, 0.55, 2.5, 2.7) },
...
const lerx: SurfaceDef = {
  ...
  angle: -4,
  stations: [
    { s: 0, le: 3.95, chord: 4.2, t: 0.022 },
    { s: 0.3, le: 5.3, chord: 3.0, t: 0.025 },
    { s: 0.56, le: 6.5, chord: 1.9, t: 0.03 },
  ],
  part: PART.fuselage,
  bone: ROOT_BONE,
  mirror: true,
